...
public class CSVDownloaderEditor : EditorWindow
{
    ...
    public static void DownloadCSVs()
    {
        ...
        {
            string url = $"https://docs.google.com/spreadsheets/u/0/d/1oO_GdwUtq97MCxSvnl_AeAnq8MThIm13MVMOjzNkrak/export?format=csv&id=1oO_GdwUtq97MCxSvnl_AeAnq8MThIm13MVMOjzNkrak&gid={sheet.Value}";
