...
public class CSVDownloaderEditor : EditorWindow
{
    ...
    public static void DownloadCSVs()
    {
        ...
        {
            string url = $"https://docs.google.com/spreadsheets/d/1HKmv7JCwqAQGGxA361nO0V_E8HfC5RkxSU-OMMx127Y/export?format=csv&id=1HKmv7JCwqAQGGxA361nO0V_E8HfC5RkxSU-OMMx127Y&gid={sheet.Value}";
