...
public class CSVDownloaderEditor : EditorWindow
{
    ...
    public static void DownloadCSVs()
    {
        foreach (var sheet in sheetIds)
        {
            ...
            //string url = $"https://docs.google.com/spreadsheets/u/0/d/1SKttr_HWyf_27mcdkaDspWrscGZ3a55PNPBQS6c5NTI/export?format=csv&id=1SKttr_HWyf_27mcdkaDspWrscGZ3a55PNPBQS6c5NTI&gid={sheet.Value}";
